/*! knockstrap 1.2.1 http://faulknercs.github.io/Knockstrap/ | (c) 2013-2015 Artem Stepanyuk |  http://www.opensource.org/licenses/mit-license */
...
(function (factory) {
    ...
    (function () {
        ...
        templates.carouselIndicators="<ol class=\"carousel-indicators\" data-bind=\"foreach: items\"> <li data-bind=\"attr: { 'data-target': $parent.id, 'data-slide-to': $index }, css: { active: $index() == 0 }\"></li> </ol> ";
        ...
        templates.progress="<div class=\"progress-bar\" role=\"progressbar\" aria-valuemin=\"0\" aria-valuemax=\"100\" data-bind=\"style: { width: barWidth }, attr: { 'aria-valuenow': value }, css: { active: animated, 'progress-bar-striped': striped }, 'class': barType\"> <span data-bind=\"css: { 'sr-only': textHidden }\"> <span data-bind=\"text: value\"></span> <span data-bind=\"visible: percentageSignVisible\"><span> <span data-bind=\"text: text\"></span> </span> </div> ";
